...
const PAGES = [
  ...
  { md: "37_细节解析与故事线闭合.md",      slug: "37-synthesis",         num: "37",     title: "细节解析与故事线闭合",    brief: "三纪骨干事件链 / 八件信物溯源 / 九句关键引文谱系 / 角色姿态传递网 / 三层呼应 / 故事线如何在 SY 80 春分同时闭合。读完整部 EOOVE 之后的最后一道连接。", kind: "appendix" },
];
